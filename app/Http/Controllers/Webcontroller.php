...
class Webcontroller extends Controller
{
    ...
    public function update(Request $request, DataPelanggan $DataPelanggan) {
        ...
        return redirect('/hero')->with('Update', 'Data berhasil terupdate');
    ...
    //         $keyword = DataPelanggan::where('name', 'LIKE', '%'.$request->search.'%')->get();
    //      }
    //     else {
    //         $keyword = DataPelanggan::all();
    //     }
        
    //     return view('hero', [
    //         'DataPelanggan' => $keyword
    //     ]);
    }
